					...
					<table>
						...
						<tr>
							...
							<td class="pole_przycisku">
								...
								<input type="text" name="name" required="required" pattern="^[A-Za-z]+$" maxlength="45"
						...
						<tr>
							<td><b> E-mail:</b></td>
							<td class="pole_przycisku"><input type="text" name="mail" required="required" maxlength="45"
									value=" ${userval.getEmail()}"></td>
						</tr>
						<tr>
							<td><b> Nr konta:</b></td>
							<td class="pole_przycisku"><input type="text" name="account" required="required"
									pattern="^[0-9]+$" maxlength="26" value=" ${userval.getAccount_number()}"></td>
						</tr>
						<tr>
