        ...
        <div class="page">
            <table>
                <form method="POST" action="/addU" autocomplete="off">
                    ...
                    <tr>
                        <td>Login</td>
                        <td class="pole_przycisku"><input type="text" name="login" required="required" maxlength="30">
                        </td>
                    </tr>
                    <tr>
                        <td> Hasło: </td>
                        <td class="pole_przycisku"><input type="password" name="password" autocomplete="new-password"
                    ...
                    <tr>
                        <td> E-mail:</td>
                        <td class="pole_przycisku"><input type="email" name="mail" required="required" maxlength="45">
                        </td>
                    </tr>
                    <tr>
                        <td> Nr konta:</td>
                        <td class="pole_przycisku"><input type="text" name="account" required="required"
                                pattern="^[0-9]+$" maxlength="26"></td>
                    </tr>
                    <tr>
                        <td> Wypłata NETTO:</td>
